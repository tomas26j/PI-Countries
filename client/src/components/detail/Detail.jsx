...
import { getDetail, setDetail } from "../../redux/actions.js";
    ...
    return(
        ...
        <div className={styles.container}>
            ...
            <div className={styles.card} key={id}>
                <img src={countries[0].flags} className={styles.tokenImage} alt="Country Flag"/>
                ...
                countries[0].activities.map(e => ` Name: ${e.name[0].toUpperCase() + e.name.substring(1)}, Difficulty: ${e.difficulty}, Duration: ${e.duration}hrs, Season: ${e.season}.`) : 'No activities.'}</h4>
                <hr/>
                    <Link to='/home'>
